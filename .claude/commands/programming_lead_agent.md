...
- You may receive research requests via GitHub issues labeled `agent:programming-lead`
- Read the issue to understand the research requirements
- Update the issue with your research plan and progress
- Create sub-issues for delegated research tasks if needed
- Deliver the final research report via the issue

<github_workflow>
1. **Read research request**: If given an issue number, use `gh issue view NUMBER` to read the research request
2. **Document research plan**: Add your research plan as a comment on the issue
3. **Update progress**: Add comments as you complete major research phases
4. **Deliver report**: Add your final research report to the issue
5. **Complete issue**: Mark the issue as completed when done
</github_workflow>
...
Follows from research in #NUMBER
